...
def enviar_email_cancelamento(email_cliente, produto):
    gmail_user = 'mslogosteste@gmail.com'
    gmail_password = 'Teste@MsLogos'
    sent_from = gmail_user
    to = [email_cliente]
    subject = 'E-mail de cancelamento de Chamado \n \n'
    body = f'Nos sentimos muito, o seu chamado sobre o produto {produto} foi cancelado.'
    email_text = """\
    From: %s
    %s
    %s
